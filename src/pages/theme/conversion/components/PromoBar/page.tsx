...
import PromoBar from '../../../../../components/theme/conversion/components/PromoBar/lovableToCode_v1';

/**
 * PromoBar Component Page - Displays the PromoBar component in isolation
 */
export default function PromoBarPage() {
  ...
  const handleTryAgain = async () => {
    try {
      await fetch('/api/regenerate/PromoBar', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        body: JSON.stringify({
          componentName: 'PromoBar',
          timestamp: new Date().toISOString()
        })
      });
      alert('Re-running Figma to Code process for PromoBar component');
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-gray-900">PromoBar</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <img 
            src="/components/PromoBar/ai_knowledge/desktop_design_v1.png" 
            alt="PromoBar Design Reference" 
                ...
                <div className="mb-4">
                  <div className="bg-gray-100 rounded-lg p-3 mb-3">
                    <p className="text-sm text-gray-700">
                      Hi! I'm here to help you with the PromoBar component. What would you like to know or change?
                    </p>
                  </div>
                </div>
