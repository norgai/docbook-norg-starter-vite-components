...
import ConditionGrid from '../../../../../components/theme/conversion/components/ConditionGrid/lovableToCode_v1';

/**
 * ConditionGrid Component Page - Displays the ConditionGrid component in isolation
 */
export default function ConditionGridPage() {
  ...
  const handleTryAgain = async () => {
    try {
      await fetch('/api/regenerate/ConditionGrid', {
        method: 'POST',
        headers: {
      ...
      alert('Re-running Figma to Code process for ConditionGrid component');
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold text-gray-900">ConditionGrid</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <img 
            src="/components/ConditionGrid/ai_knowledge/desktop_design_v1.png" 
            alt="ConditionGrid Design Reference" 
                ...
                <div className="mb-4">
                  <div className="bg-gray-100 rounded-lg p-3 mb-3">
                    <p className="text-sm text-gray-700">
                      Hi! I'm here to help you with the ConditionGrid component. What would you like to know or change?
                    </p>
                  </div>
                </div>
